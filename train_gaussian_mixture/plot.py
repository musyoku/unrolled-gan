...
def main():
	num_samples = 10000
	samples_true = sampler.gaussian_mixture_double_circle(num_samples, num_cluster=generator_params["config"]["num_mixture"], scale=2, std=0.2)
	...
	plot_scatter(samples_fake, args.plot_dir, "scatter_gen.png")
	plot_kde(samples_fake, args.plot_dir, "kde_gen.png")
